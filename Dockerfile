...
# --- START: Add Docker CLI installation ---
# The selenium/standalone-chrome image is based on Debian, so use Debian's Docker repository setup
...
# --- END: Add Docker CLI installation ---
...
# The virtual environment is at /opt/venv in selenium/standalone-chrome images
